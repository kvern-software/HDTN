    ...
    //scope to ensure clean exit before return 0
    {
        ...
        try {
            desc.add_options()
                ...
                ("sdp-sending-interval-ms", boost::program_options::value<uint64_t>()->default_value(5000), "Interval in milliseconds that SDP information is sent");
                ...
                sdpIntervalMs = vm["sdp-sending-interval-ms"].as<uint64_t>();
