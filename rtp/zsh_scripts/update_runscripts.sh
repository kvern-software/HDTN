...
# run scripts
sshpass -p "jetson"  scp -r HDTN/rtp/zsh_scripts/ltp/lunanet_test jetson@10.1.1.99:/home/jetson/HDTN/rtp/zsh_scripts/ltp/
...
# config files
sshpass -p "jetson" scp -r HDTN/rtp/config_files/ltp/test_6_luna_net jetson@10.1.1.99:/home/jetson/HDTN/rtp/config_files/ltp/
...
# contact plan
sshpass -p "jetson" scp HDTN/rtp/config_files/contact_plans/LunaNetContactPlanNodeIDs.json jetson@10.1.1.99:/home/jetson/HDTN/rtp/config_files/contact_plans
...
# source code 
# sshpass -p "temppwd" scp -r HDTN/rtp/BpInduct jetson@10.1.1.99:/home/jetson/HDTN/rtp