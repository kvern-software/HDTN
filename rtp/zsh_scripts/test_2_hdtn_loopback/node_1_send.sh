...
source_config=$config_files/test_2_hdtn_loopback/mediasource_ltp.json
...
./build/bpsend_stream  --bundle-size=2000 --bundle-rate=0 --use-bp-version-7 \
        ...
        --enable-rtp-concatenation=false --sdp-filepath="zsh_scripts/test_2_hdtn_loopback/HDTN.sdp" --sdp-sending-interval-ms=5000 --rtp-packets-per-bundle=5 &
