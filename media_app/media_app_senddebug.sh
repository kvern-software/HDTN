...
#bpgen
gdb -q -ex=r --args ./build/media_source  --frames-per-second=30 --video-device=/dev/video0 --bundle-size=200000 --bundle-rate=0 --my-uri-eid=ipn:1.1 --dest-uri-eid=ipn:2.1 --duration=400 --outducts-config-file=$gen_config &
# sleep 8
