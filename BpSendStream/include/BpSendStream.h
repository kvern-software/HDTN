...
#include "BpSourcePattern.h"
#include "Rtp.h"
class BpSendStream : public BpSourcePattern
{
public:
    BpSendStream(size_t maxIncomingUdpPacketSizeBytes, uint16_t incomingRtpStreamPort, uint64_t numCircularBufferVectors);
    ~BpSendStream();
    ...
    int InitializeDtnRtp(rtp_format_t fmt, 
